...
const UsersContainer = connect(mapStateToProps, {follow, setCurrentPage, setIsFetching, setTotalUserCount, setUsers, unFollow,setIsFollowingProgress})(UsersContainerFunc);
